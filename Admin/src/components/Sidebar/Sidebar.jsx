...
const Sidebar = () => {
  ...
  return (
    <div className='sidebar w-[18%] min-h-[100vh]  border-t-0 border-[1.5px] border-[#a9a9a9] text-[16px] '>
      <div className="sidebar-options pt-[25px] pl-[20%] flex flex-col gap-5">
      ...
      <NavLink to='/add'><div onClick={()=>setActive("add")} className={active==="add"?"sidebar-option bg-orange-100 flex items-center gap-4 border-r-0 border-[1px] border-[#a9a9a9] px-[10px] py-[8px] rounded-l-md cursor-pointer" :"sidebar-option flex items-center gap-4 border-r-0 border-[1px] border-[#a9a9a9] px-[10px] py-[8px] rounded-l-md cursor-pointer"}>
        ...
        <NavLink to='/order'>
        <div onClick={()=>setActive("order")} className={active==="order"?"sidebar-option bg-orange-100 flex items-center gap-4 border-r-0 border-[1px] border-[#a9a9a9] px-[10px] py-[8px] rounded-l-md cursor-pointer" :"sidebar-option flex items-center gap-4 border-r-0 border-[1px] border-[#a9a9a9] px-[10px] pt-[8px] rounded-l-md cursor-pointer"}>
        <img src={assets.order_icon} alt="" />
