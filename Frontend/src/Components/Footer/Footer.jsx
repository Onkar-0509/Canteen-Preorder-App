...
const Footer = () => {
  return (
    <div id='footer' className='footer text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-5  px-5 py-[4vw] mt-[100px]  '>
        <div className="footer-content  grid gap-[80px] grid-cols-[2fr_1fr_1fr] w-[90%] mx-auto"> 
            <div className="footer-content-left flex flex-col items-start gap-[20px]">
                <img  src={assets.logo} alt="" />
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus quia neque labore. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officiis debitis vel dolorum!</p>
                ...
                <div className="footer-content-right flex flex-col items-center gap-[20px]">
                    ...
                    <ul>
                        <li className=' list-none mb-[10px] cursor-pointer '>+91-9322714198</li>
                        <li className=' list-none mb-[10px] cursor-pointer '>shingadesuraj59@gmail.com</li>
                    </ul>
                    </div>
                
              </div>
      <hr className='w-[95%] h-[2px] mx-5 bg-gray-700 mt-5' />
      <p className='footer-copyright'>Copyright 2025 @ Suraj Shingade - All right reserved</p>
    </div>
  )
}
